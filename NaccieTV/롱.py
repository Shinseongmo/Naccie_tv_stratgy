...
# 두번째 변화 관측---------------------------------------------------------- 
                    if lowest+throw_position > Close_coin() :    
                        ...
                        while True:
                            ...
                            Trace()
# 세번째 바닥---------------------------------------------------------- 
                            if lowest+throw_position > Coin_last() and ((highest_temp - lowest_temp)/2) > Coin_last():
                                Third_pass()
                                Coin_last()
                                try:
                                    ...
                                    # 세번째 바닥---------------------------------------------------------- 
                                                                    if lowest+throw_position > Coin_last() and ((highest_temp - lowest_temp)/2) > Coin_last():
                                                                        ...
                                                                        order = binance.create_market_buy_order(symbol=symbol0,amount='{}'.format(amount0), params = {'positionSide': 'LONG'})
                                                                        A=1
                                                                    elif lowest+throw_position > Coin_last() and ((highest_temp - lowest_temp)/2) < Coin_last():
                                                                        Third_pass()
                                                                        Coin_last()
